...
const Footer = () => {
  return (
    <footer className="glass border-t border-border/50 py-8 mt-auto">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex items-center gap-6">
            <a
              ...
              aria-label="LinkedIn"
            >
              <div className="p-3 rounded-xl glass group-hover:bg-[#0077b5]/10 transition-all duration-300">
            ...
            <a
              ...
              aria-label="GitHub"
            >
              <div className="p-3 rounded-xl glass group-hover:bg-foreground/10 transition-all duration-300">
            ...
            <a
              ...
              aria-label="Email"
            >
              <div className="p-3 rounded-xl glass group-hover:bg-gold/10 transition-all duration-300">
